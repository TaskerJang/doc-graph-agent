...
| ---- | -------------------------------------------------- | -------- | ---------- | ----- |
| 0001 | DART 채택, FIBO 보편 클래스 차용                  | Accepted | 2026-05-02 | #?    |
| 0002 | Section 스키마 옵션 C — 보편 라벨 + 속성 2-tier   | Accepted | 2026-05-02 | #?    |

## 향후 작성 예정

| 예정 # | 주제                                  | 시점     |
| ----- | ------------------------------------- | -------- |
| 0003  | LLM 선택 (Kimi 채택 근거)             | W3 초    |
| 0004  | NED 알고리즘 선택                      | W3 후반  |
