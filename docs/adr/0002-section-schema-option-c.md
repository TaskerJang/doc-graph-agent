...
[ADR-0001](./0001-dart-adoption.md)에서 DART 1차 채택을 결정한 직후, Layer A Section 스키마 구체 설계를 위해 평가 셋 41 QA를 분석한 결과 다음이 드러남:

- DART 사업보고서 표준 목차 11개를 직접 라벨로 사용하기 어려움
- 평가 셋 문서 분포:
  - 증권사 기업분석 리포트(한화-두산밥캣): 6 QA (15%)
  - 증권사 시황 리포트(DS): 5 QA (12%)
  - IR 실적 보고서(미래에셋 1Q~4Q): 18 QA (44%)
  - 사업보고서(농협 HWP): 5 QA (12%)
  - 보도자료(금감원 DOCX): 6 QA (15%)
- DART 사업보고서 양식이 직접 적용되는 비중은 12%(농협 1건)뿐
