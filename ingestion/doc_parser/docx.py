# Ported from doc-summary-agent/doc_parser/docx.py (#11).
...
from ingestion.doc_parser.exceptions import EmptyDocumentError, FileCorruptedError, FileNotSupportedError
