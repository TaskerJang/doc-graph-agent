# Ported from doc-summary-agent/doc_parser/pdf.py (#11).
# Source: TaskerJang/doc-summary-agent@dev as of 2026-05-03.
# 변경: import path를 ingestion.doc_parser.* 로 조정.
import re
from pathlib import Path

from ingestion.doc_parser.ocr_cache import extract_text_with_cache, extract_page_with_cache
...
def _supplement_images_with_tables(content: str, pdf_path: Path, page_index: int) -> str:
    ...
    """
    from ingestion.doc_parser.table_extractor import extract_tables_from_page_safe
